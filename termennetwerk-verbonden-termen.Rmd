...
Er is een aantal connecties met andere bronnen, zoals de output hierboven laat zien. Het percentage links is met 1.5% erg laag, wellicht vanwege de status van de AAT binnen het veld.

(N.B.: we gebruiken de CHT-service omdat het niet lukt om het POST request direct naar het AAT-endpoint te sturen... Ook is het niet altijd mogelijk om de AAT op deze manier te bevragen, dus het zou kunnen dat je hierboven geen resultaten kunt zien.)
